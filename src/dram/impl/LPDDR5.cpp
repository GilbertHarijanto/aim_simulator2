...
namespace Ramulator
{
    ...
    public:
        inline static const std::map<std::string, Organization> org_presets = {
            ...
            {"LPDDR6_2Gb_x16", {2 << 10, 16, {1, 4, 4, 1 << 13, 1 << 10}}},
            {"LPDDR6_4Gb_x16", {4 << 10, 16, {1, 4, 4, 1 << 14, 1 << 10}}},
            {"LPDDR6_8Gb_x16", {8 << 10, 16, {1, 4, 4, 1 << 15, 1 << 10}}},
            {"LPDDR6_16Gb_x16", {16 << 10, 16, {1, 4, 4, 1 << 16, 1 << 10}}},
            {"LPDDR6_32Gb_x16", {32 << 10, 16, {1, 4, 4, 1 << 17, 1 << 10}}},
            {"LPDDR6_AiM_org",
             {128 << 10,   // density
              16,          // DQ (2B)
              {32,         // Ch
        ...
        inline static const std::map<std::string, std::vector<int>> timing_presets = {
            ...
            {"LPDDR6_AiM_timing", // name
             {
                 6400, // rate
                 4,    // nBL (changed 1.25)
                 20,   // nCL (changed)
                 15,   // nRCDRD (changed) 15
                 35,   // nRCDRDMAC (changed + 10ns offset) 35
                 15,   // nRCDEWMUL (changed, calculated based on SDK) 15
                 65,   // nRCDRDAF (changed + 25ns offset) 65
                 45,   // nRCDRDCP (changed + 15ns offset) 45
                 15,   // nRCDWR (changed) 15
                 35,   // nRCDWRCP (changed + 10ns) 35
                 16,   // nRP (changed) 16
                 34,   // nRAS (changed from SIM: RDSBK (opsize=1) = ACT + RD + PRE = nRAS + nRP = nRAS + 32 = 86) 34
                 30,   // nRC (not imported, used only for precharge) 30
                 28,   // nWR (changed 16.625) 28
                 4,    // nRTP (changed 6.25) 4
                 11,   // nCWL 11
                 4,    // nCCDS (changed from ISSCC) 4
                 4,    // nCCDL (based on Xavier's WRSBK and RDSBK profiling results) 4
                 4,    // nRRDS 4
                 4,    // nRRDL 4
                 5,    // nWTRS 5
                 10,   // nWTRL 10
